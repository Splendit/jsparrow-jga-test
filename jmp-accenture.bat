...
REM CALL mvn jsparrow:refactor -X -Db -Dlicense=I2ZGK32V2 > ".."\%debug-dir%\%debug-build-workspace%\jmp-standard.log 2> ".."\%debug-dir%\%debug-build-workspace%\jmp-standard-errors.log
...
REM CALL mvn jsparrow:refactor -X -Du -Dlicense=I2ZGK32V2 > ".."\%debug-dir%\%debug-maven-update%\jmp-standard.log 2> ".."\%debug-dir%\%debug-maven-update%\jmp-standard-errors.log
...
REM CALL mvn jsparrow:refactor -X -Db -Du -Dlicense=I2ZGK32V2 > ".."\%debug-dir%\%debug-update-and-build-workspace%\jmp-standard.log 2> ".."\%debug-dir%\%debug-update-and-build-workspace%\jmp-standard-errors.log
