...
public final class ObjectUtils {
	...
	/**
	 * Returns a new collection containing clones of all the items in the specified
	 * collection.
	 *
	 * @param            <T> The object type.
	 ...
	 *                                    cannot be cloned.
	 */
	public static <T, C extends Collection<T>> C deepClone(final C collection) throws CloneNotSupportedException {
