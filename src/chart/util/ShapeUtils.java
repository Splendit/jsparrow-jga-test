...
public class ShapeUtils {
	...
	/**
	 * Returns a clone of the specified shape, or {@code null}. At the current time,
	 * this method supports cloning for instances of {@code Line2D},
	 ...
	 *
	 * @param shape the shape to clone ({@code null} permitted, returns
	 *              {@code null}).
	 *
	...
	/**
	 * Tests two shapes for equality. If both shapes are {@code null}, this method
	...
	/**
	 * Tests two polygons for equality. If both are {@code null} this method returns
	 * {@code true}.
	 *
	...
	/**
	 * Translates a shape to a new location such that the anchor point (relative to
	 * the rectangular bounds of the shape) aligns with the specified (x, y)
	 ...
	 */
	public static Shape createTranslatedShapee(Shape shape, double locationX, double locationY) {
	 ...
	 */
	public static void drawRotatedShape(Graphics2D g2, final Shape shape, double angle, float x, final float y) {
	...
	/**
	 * Creates a region surrounding a line segment by 'widening' the line segment. A
	 * typical use for this method is the creation of a 'clickable' region for a
	 * line that is displayed on-screen.
	 *
	...
	/**
	 * Returns {@code true} if the specified point {@code (x, y)} falls within or on
	 * the boundary of the specified rectangle.
	 *
	...
	/**
	 * Returns a point based on (x, y) but constrained to be within the bounds of a
	 * given rectangle.
	 *
	 * @param x    the x-coordinate.
	 * @param y    the y-coordinate.
