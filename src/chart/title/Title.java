 ...
 */
public abstract class Title extends AbstractBlock implements Block {
	 ...
	 * corpus.
	 */
	private static final Set<String> parameters = Collections.unmodifiableSet(
			new HashSet<>(Arrays.asList("visible", "position", "horizontalAlignment", "verticalAlignment")));
	/**
