...
import chart.entity.TitleEntity;
 ...
 * required.
 */
public class TextTitle extends Title implements PublicCloneable {
	 ...
	 * Creates a new title.
	 *
	 * @param text                the text for the title (<code>null</code> not
	 *                            permitted).
	 * @param font                the title font (<code>null</code> not permitted).
	 * @param paint               the title paint (<code>null</code> not permitted).
	 * @param position            the title position (<code>null</code> not
	 *                            permitted).
	 * @param horizontalAlignment the horizontal alignment (<code>null</code> not
	 *                            permitted).
	 * @param verticalAlignment   the vertical alignment (<code>null</code> not
	 *                            permitted).
	 * @param padding             the space to leave around the outside of the
	 *                            title.
	 */
	...
	/**
	 * Returns the text alignment. This controls how the text is aligned within the
	 * title's bounds, whereas the title's horizontal alignment controls how the
	 * title's bounding rectangle is aligned within the drawing space.
	 *
	...
	/**
	 * Returns the flag that controls whether or not the title expands to fit the
	 * available space.
	 *
	 * @return The flag.
	 */
	...
	/**
	 * Sets the flag that controls whether the title expands to fit the available
	 * space, and sends a {@link TitleChangeEvent} to all registered listeners.
	 *
	...
	/**
	 * Arranges the content for this title assuming no bounds on the width or the
	 * height, and returns the required size. This will reflect the fact that a text
	 * title positioned on the left or right of a chart will be rotated by 90
	 * degrees.
	 *
	...
	/**
	 * Arranges the content for this title assuming a range constraint for the width
	 * and no bounds on the height, and returns the required size. This will reflect
	 * the fact that a text title positioned on the left or right of a chart will be
	 ...
	 * @param g2     the graphics device.
	 * @param area   the area.
	 * @param params if this is an instance of {@link EntityBlockParams} it is used
