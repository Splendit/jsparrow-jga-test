 ...
 */
public class BlockContainer extends AbstractBlock implements Block, PublicCloneable {
	 ...
	 *
	 * @param arrangement the arrangement manager (<code>null</code> not permitted).
	 */
	...
	public Object draw(Graphics2D g2, Rectangle2D area, Object params) {
		...
		for (Block block : this.blocks) {
			...
			Rectangle2D drawArea = new Rectangle2D.Double(bounds.getX() + area.getX(), bounds.getY() + area.getY(),
