...
public class LegendItem implements Cloneable, Serializable {
	...
	/**
	 * Creates a legend item with the specified label. The remaining attributes take
	 * default values.
	 *
	...
	/**
	 * Creates a legend item with the specified label and fill paint. The remaining
	 ...
	 * @param shapeOutlineVisible a flag that controls whether or not the shape is
	 *                            outlined.
	...
	/**
	 * Sets the flag that controls whether or not the line shape is visible for this
	 * legend item.
	 *
	 * @param visible the new flag value.
	 *
	...
	/**
	 * Returns an independent copy of this object (except that the clone will still
	 * reference the same dataset as the original <code>LegendItem</code>).
	 *
	 * @return A clone.
	 *
