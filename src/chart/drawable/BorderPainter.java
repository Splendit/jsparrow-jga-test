...
public class BorderPainter implements Drawable, Serializable {
    ...
    public int hashCode() {
        ...
        hash = 83 * hash + (int) (Double.doubleToLongBits(this.arc_Height) 
                ^ (Double.doubleToLongBits(this.arc_Height) >>> 32));
        hash = 83 * hash + (int) (Double.doubleToLongBits(this.arc_Width) 
                ^ (Double.doubleToLongBits(this.arc_Width) >>> 32));
        return hash;
    }
