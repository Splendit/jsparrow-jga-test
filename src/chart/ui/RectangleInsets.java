...
public class RectangleInsets implements Serializable {
	 ...
	 * @param right    the right insets.
	 */
	public RectangleInsets(final UnitType unitType, final double top, final double left, final double bottom,
			final double right) {
		if (unitType == null) {
	 ...
	 * specified by this instance, and the horizontal and vertical adjustment types.
	 *
	 ...
	 */
	public Rectangle2D createAdjustedRectangle(final Rectangle2D base, final LengthAdjustmentType horizontal,
	...
	public Rectangle2D createInsetRectangle(final Rectangle2D base, final boolean horizontal, final boolean vertical) {
		...
		return new Rectangle2D.Double(base.getX() + leftMargin, base.getY() + topMargin,
