...
public class ChartMouseEventFX extends EventObject {
	 ...
	 * @param trigger the mouse event that triggered this event ({@code null} not
	 *                permitted).
	 * @param entity  the chart entity (if any) under the mouse point ({@code null}
	 *                permitted).
	 */
