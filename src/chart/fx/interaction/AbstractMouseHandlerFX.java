...
public class AbstractMouseHandlerFX implements MouseHandlerFX {
	...
	/**
	 * A flag used to enable/disable the handler (usually temporarily, removing a
	 * handler is the preferred way to disable it permanently).
	 */
	...
	/**
	 * Creates a new instance. The modifier keys are used to select a mouse handler
	 * to be the current "live" handler (when a handler is used as an auxiliary
	 * handler, the modifier keys are not relevant).
	 * 
	...
	/**
	 * Returns <code>true</code> if the specified mouse event has modifier keys that
	 * match this handler.
	 * 
	...
	/**
	 * Handles a mouse moved event. This implementation does nothing, override the
	 * method if required.
	 * 
	...
	/**
	 * Handles a mouse clicked event. This implementation does nothing, override the
	 * method if required.
	 * 
	 * @param canvas the canvas (<code>null</code> not permitted).
	 * @param e      the event (<code>null</code> not permitted).
	...
	/**
	 * Handles a mouse pressed event. This implementation does nothing, override the
	 * method if required.
	 * 
	 * @param canvas the canvas (<code>null</code> not permitted).
	 * @param e      the event (<code>null</code> not permitted).
	...
	/**
	 * Handles a mouse dragged event. This implementation does nothing, override the
	 * method if required.
	 * 
	 * @param canvas the canvas (<code>null</code> not permitted).
	 * @param e      the event (<code>null</code> not permitted).
	...
	/**
	 * Handles a mouse released event. This implementation does nothing, override
	...
	/**
	 * Handles a scroll event. This implementation does nothing, override the method
	 * if required.
	 * 
	 * @param canvas the canvas (<code>null</code> not permitted).
	 * @param e      the event (<code>null</code> not permitted).
