...
/**
 * A tuple of int. There are special classes for IntUni, IntPair, IntTriple and
 * IntQuadruple. The motivation for that was the different hashCode
 * implementations. By using the static IntTuple.getIntTuple(numElements) one
 * can obtain an instance of the appropriate sub-class.
 *
...
public class IntTuple implements Serializable, Comparable<IntTuple> {
	...
	public void shiftLeft() {
		System.arraycopy(elements, 1, elements, 0, elements.length - 1); // the API does guarantee that this works when
																			// src and dest overlap, as here
