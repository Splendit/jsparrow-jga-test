...
public class KeyedObjects implements Cloneable, PublicCloneable, Serializable {
	...
	public List<Comparable> getKeys() {
		List<Comparable> result = new java.util.ArrayList<>();
		this.data.forEach(ko -> result.add(ko.getKey()));
		return result;
	}
	...
	/**
	 * Inserts a new value at the specified position in the dataset or, if there is
	 * an existing item with the specified key, updates the value for that item and
	...
	/**
	 * Returns a clone of this object. Keys in the list should be immutable and are
	 * not cloned. Objects in the list are cloned only if they implement
